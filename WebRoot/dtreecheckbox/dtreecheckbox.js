...
function dTree(objName, iPath, formId) {
	...
	this.icon = {
		root				: 'widgets/dtreecheckbox/img/base.gif',
		folder				: 'widgets/dtreecheckbox/img/folder.gif',
		folderOpen			: 'widgets/dtreecheckbox/img/folderopen.gif',
		node				: 'widgets/dtreecheckbox/img/page.gif',
		empty				: 'widgets/dtreecheckbox/img/empty.gif',
		line				: 'widgets/dtreecheckbox/img/line.gif',
		join				: 'widgets/dtreecheckbox/img/join.gif',
		joinBottom			: 'widgets/dtreecheckbox/img/joinbottom.gif',
		plus				: 'widgets/dtreecheckbox/img/plus.gif',
		plusBottom			: 'widgets/dtreecheckbox/img/plusbottom.gif',
		minus				: 'widgets/dtreecheckbox/img/minus.gif',
		minusBottom			: 'widgets/dtreecheckbox/img/minusbottom.gif',
		nlPlus				: 'widgets/dtreecheckbox/img/nolines_plus.gif',
		nlMinus				: 'widgets/dtreecheckbox/img/nolines_minus.gif'
	};
	this.parEnum = "";
	this.obj = objName;
	this.aNodes = [];
