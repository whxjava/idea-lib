...
<head>
	...
	$(function(){
		...
		$("a[id^=DelMsg]").click(function(){
			if(confirm("确认要删除吗？")){
				var Id = $(this).attr("id").substring(7);
				$.getJSON("messageDel.action",{"Id":Id},function(data){
					if(data == "success"){
...
<div class="table_container">
    ...
    <div class="table_container_main">
        <table width="800" border="0" cellspacing="1">
			...
			<s:iterator id="listMsg" value="listMsg" status="rowStatus">
			 <tr class="<s:if test="#rowStatus.odd == true">table_content</s:if><s:else>table_content_gray</s:else>">
               	<td><s:property value="Id"/></td>
                <td width="300"><s:property value="msgTitle" /></td>         
                <td><s:property value="userInfo.userName" /></td>
                <td><a href="messageFindById.action?Id=<s:property value="Id"/>" >更新信息</a></td>
                <td><a href="javascript:void(0)" id="DelMsg_<s:property value="Id"/>">删除信息</a></td>
                <td><a href="javascript:void(0)" id="showMsg_<s:property value="Id"/>">查看详情</a></td>
            </tr>
			</s:iterator>
        </table>
    </div>
