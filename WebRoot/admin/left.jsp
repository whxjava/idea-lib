    ...
    <tr>
        <td width="182" valign="top"><div id="container">
            ...
            <div class="content">
                ...
                <ul class="MM">
                    <li><a href="systemMenu.jsp" target="main">栏目管理</a></li>
                    <!-- <li><a href="#" target="main">角色管理</a></li>-->
                    <li><a href="user.action" target="main">用户管理</a></li>
                    <li><a href="addMsg.jsp" target="main">添加信息</a></li>
                    <li><a href="messageFindPage.action" target="main">信息管理</a></li>
                </ul>
            </div>
